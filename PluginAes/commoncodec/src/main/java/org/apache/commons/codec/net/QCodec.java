 ...
 */
public class QCodec extends RFC1522Codec implements com.apache.commons.codec.StringEncoder, com.apache.commons.codec.StringDecoder {
    /**
    ...
    @Override
    protected byte[] doDecoding(final byte[] bytes) throws com.apache.commons.codec.DecoderException {
        if (bytes == null) {
            return null;
        }
