...
import com.apache.commons.codec.Charsets;
 ...
 */
public class QuotedPrintableCodec implements com.apache.commons.codec.BinaryEncoder, com.apache.commons.codec.BinaryDecoder, com.apache.commons.codec.StringEncoder, com.apache.commons.codec.StringDecoder {
    /**
     ...
     * @throws com.apache.commons.codec.DecoderException
     *             Thrown if quoted-printable decoding is unsuccessful
     */
    public static final byte[] decodeQuotedPrintable(final byte[] bytes) throws com.apache.commons.codec.DecoderException {
        if (bytes == null) {
            return null;
        }
        final ByteArrayOutputStream buffer = new ByteArrayOutputStream();
        for (int i = 0; i < bytes.length; i++) {
            ...
            if (b == ESCAPE_CHAR) {
                try {
                    ...
                    throw new com.apache.commons.codec.DecoderException("Invalid quoted-printable encoding", e);
                }
            } else if (b != CR && b != LF) {
     ...
     */
    @Override
    public byte[] decode(final byte[] bytes) throws com.apache.commons.codec.DecoderException {
     ...
     * @since 1.7
     */
    public String decode(final String str, final Charset charset) throws com.apache.commons.codec.DecoderException {
        if (str == null) {
            return null;
        }
     ...
     */
    public String decode(final String str, final String charset) throws com.apache.commons.codec.DecoderException, UnsupportedEncodingException {
        if (str == null) {
            return null;
        }
     ...
     */
    @Override
    public String decode(final String str) throws com.apache.commons.codec.DecoderException {
     ...
     */
    @Override
    public Object decode(final Object obj) throws com.apache.commons.codec.DecoderException {
        if (obj == null) {
            return null;
        } else if (obj instanceof byte[]) {
            ...
            throw new com.apache.commons.codec.DecoderException("Objects of type " +
                  obj.getClass().getName() +
